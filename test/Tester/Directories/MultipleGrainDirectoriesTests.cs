...
namespace Tester.Directories
{
    public class MultipleGrainDirectoriesTests : TestClusterPerTest
    {
        public class SiloConfigurator : ISiloConfigurator
        {
            ...
            {
                siloBuilder
                    .AddAzureTableGrainDirectory(AzureTableDirectoryGrain.DIRECTORY, options => options.ConnectionString = TestDefaultConfiguration.DataConnectionString);
            }
        }
    ...
    //public class MultipleGrainDirectoriesTests : IClassFixture<MultipleGrainDirectoriesTests.Fixture>
    //{
