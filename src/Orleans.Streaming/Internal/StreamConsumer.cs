            ...
            if (myExtension == null)
            {
                using (await bindExtLock.LockAsync())
                {
                    if (myExtension == null)
                    {
                        ...
                        (myGrainReference, myExtension) = providerRuntime.BindExtension<IStreamConsumerExtension, StreamConsumerExtension>(() => new StreamConsumerExtension(providerRuntime));
