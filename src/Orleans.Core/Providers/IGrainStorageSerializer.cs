...
namespace Orleans.Storage
{
    ...
    {
        public static ReadOnlyMemory<byte> Serialize(this IGrainStorageSerializer self, Type t, object value)
        {
#if NETCOREAPP
        ...
        public static object Deserialize(this IGrainStorageSerializer self, Type expected, ReadOnlyMemory<byte> input)
        {
