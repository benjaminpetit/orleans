...
namespace Orleans.Storage
{
    ...
    public class DefaultRelationalStoragePicker: IStorageSerializationPicker
    {
        ...
        /// </summary>
        public SerializationChoice PickSerializer<T>(string servideId, string storageProviderInstanceName, string grainType, GrainId grainId, IGrainState<T> grainState, string tag = null)
        {
